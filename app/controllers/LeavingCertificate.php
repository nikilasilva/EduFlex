...
class LeavingCertificate extends Controller
{
    ...
    public function viewLeavingCertificates()
    {
        checkRole('student'); // Ensure the user is a student
        ...
        $leavingCertificates = $this->leavingCertificateModel->getAllLeavingCertificates($student->student_id);

        $data = [
            'leavingCertificates' => $leavingCertificates,
            'studentDetails' => $student
        ];

        $this->view('inc/student/ViewRequestedLeavingCertificates', $data);
    }
    ...
    public function update($id)
    {
        ...
        $student = $this->studentModel->getStudentByRegNo($regNo);
        // $leavingCertificateModel = new LeavingCertificateModel();
        $leavingCertificates = $this->leavingCertificateModel->getAllLeavingCertificates($student->student_id);
        $data = [
            'leavingCertificates' => $leavingCertificates,
            'studentDetails' => $student
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $this->leavingCertificateModel->update($id, $Updatedata, 'certificate_id');
            header("Location: " . URLROOT . "/LeavingCertificate/viewLeavingCertificates
            ");
            exit();
        }


        $this->view('inc/student/EditLeavingCertificate', $data);
    }
    ...
    public function delete($id)
    {
        ...
        $this->leavingCertificateModel->delete($id, 'certificate_id');
