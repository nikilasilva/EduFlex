...
<nav class="sidebar">
    ...
    <ul>
        ...
        <li class="nav-links"><a href="<?php echo URLROOT ?>/ViewAttendance/attendance_parent"><i class="fa-solid fa-table icon"></i><span class="text nav-text">Attendance Details</span></a></li>
