                ...
                <tbody>
                    <?php foreach ($data['activities'] as $activity): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo URLROOT; ?>/Admin/editActivity/<?php echo $activity->student_id; ?>" class="btn btn-edit">Edit</a><br></br>
                                <a href="<?php echo URLROOT; ?>/Admin/deleteActivity/<?php echo $activity->student_id; ?>" class="btn btn-delete" onclick="return confirm('Are you sure you want to delete this activity?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
