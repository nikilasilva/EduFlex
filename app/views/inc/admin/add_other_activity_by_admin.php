...
<div class="admin_layout">
    ...
    <div class="manage_actor_container">
        ...
        <form action="<?php echo URLROOT; ?>/admin/insertStudentDetails" method="POST" class="actor_form">
            ...
            <div class="form-row">
            <label for="class">Fist Period:</label>
                <select name="class" id="class" required>
            ...
            <div class="form-row">
            <label for="class">2nd Period:</label>
                <select name="class" id="class" required>
                    <option value="">Select Subject</option>
                    <option value="Subject 01">Subject01</option>
                    <option value="Subject 02">Subject 02</option>
            ...
            <div class="form-row">
            <label for="class">3rd Period:</label>
                <select name="class" id="class" required>
                    <option value="">Select Subject</option>
                    <option value="Subject 01">Subject01</option>
                    <option value="Subject 02">Subject 02</option>
            ...
            <div class="form-row">
            <label for="class">4th Period:</label>
                <select name="class" id="class" required>
                    <option value="">Select Subject</option>
                    <option value="Subject 01">Subject01</option>
                    <option value="Subject 02">Subject 02</option>
            ...
            <div class="form-row">
            <label for="class">5th Period:</label>
                <select name="class" id="class" required>
                    <option value="">Select Subject</option>
                    <option value="Subject 01">Subject01</option>
                    <option value="Subject 02">Subject 02</option>
            ...
            <div class="form-row">
            <label for="class">6th Period:</label>
                <select name="class" id="class" required>
                    <option value="">Select Subject</option>
                    <option value="Subject 01">Subject01</option>
                    <option value="Subject 02">Subject 02</option>
            ...
            <div class="form-row">
            <label for="class">8th Period:</label>
                <select name="class" id="class" required>
                    <option value="">Select Subject</option>
                    <option value="Subject 01">Subject01</option>
                    <option value="Subject 02">Subject 02</option>
            ...
            <div class="form-row">
            <label for="class">9th Period:</label>
                <select name="class" id="class" required>
                    <option value="">Select Subject</option>
                    <option value="Subject 01">Subject01</option>
                    <option value="Subject 02">Subject 02</option>
