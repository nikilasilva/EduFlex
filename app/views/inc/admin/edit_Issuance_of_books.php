...
<body>
    <div class="layout">
        ...
        <div class="container">
            ...
            <form action="<?php echo URLROOT; ?>/Admin/editActivity/<?php echo $data['activity']->student_id; ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <a href="<?php echo URLROOT; ?>/Admin/viewActivities" class="btn btn-secondary">Cancel</a>
