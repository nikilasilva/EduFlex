...
<div class="layout">
    ...
    <!-- Main content for manage Principal -->
     
    <div class="manage_by_admin">
        <h1>Manage Principal</h1>

    <br><br><br>
        <!-- Manage Principal button -->
        <div class="manage_buttons">
            <button onclick="window.location.href='<?php echo URLROOT; ?>/admin/insertprincipal'">Insert</button>
