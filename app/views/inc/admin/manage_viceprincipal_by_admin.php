...
<div class="layout">
    ...
    <!-- Main content for manage viceprinciple -->
    
    <div class="manage_by_admin">
        <h1>Manage viceprinciple</h1>
<br><br><br>
        <!-- Manage viceprinciple button -->
        <div class="manage_buttons">
            <button onclick="window.location.href='<?php echo URLROOT; ?>/admin/insert_vice_principal'">Insert</button>
