...
<div class="menu-bar">
    <div class="menu">
        <ul class="menu-links">
            ...
            <li class="nav-links"><a href="<?php echo URLROOT ?>/admin/managestudent"><i class="fa-solid fa-people-line icon"></i><span class="text nav-text">Students</span></a></li>
            ...
            <li class="nav-links"><a href="<?php echo URLROOT ?>/admin/manageteacher"><i class="fa-solid fa-person-chalkboard icon"></i><span class="text nav-text">Teachers</span></a></li>
            ...
            <li class="nav-links"><a href="<?php echo URLROOT ?>/admin/inser_tCLR"><i class="fa-solid fa-house icon"></i><span class="text nav-text">Add-Class-Room</span></a></li>
