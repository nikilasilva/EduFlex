<div class="menu-bar">
    <div class="menu">
        <ul class="menu-links">
            ...
            <!-- <li class="nav-links"><a href="<?php echo URLROOT ?>/NonAcademic/Issuance_books"><i class="fa-solid fa-book icon" aria-hidden="true"></i></i><span class="text nav-text">Issuance Books</span></a></li>
            <li class="nav-links"><a href="<?php echo URLROOT ?>/NonAcademic/ReceipfBooks"><i class="fa-solid fa-book icon"></i><span class="text nav-text">Receipt Books</span></a></li>
            <li class="nav-links"><a href="<?php echo URLROOT ?>/NonAcademic/viewActivities"><i class="fa-solid fa-book icon"></i><span class="text nav-text">See Library Activity</span></a></li> -->
            ...
            <li class="nav-links"><a href="<?php echo URLROOT ?>/NonAcademic/submitted_verify_service_charges"><i class="fa-solid fa-usd icon"></i><span class="text nav-text">Service Charges</span></a></li>
            <li class="nav-links"><a href="<?php echo URLROOT ?>/NonAcademic/requestedCertificate"><i class="fa-solid fa-certificate icon"></i><span class="text nav-text">Requested Certificates</span></a></li>
            <li class="nav-links"><a href="<?php echo URLROOT ?>/NonAcademic/allocatedTime"><i class="fa-solid fa-certificate icon"></i><span class="text nav-text">Allocated Time</span></a></li>
