<div class="menu-bar">
    <div class="menu">
        <ul class="menu-links">
            ...
            <li class="nav-links"><a href="<?php echo URLROOT ?>/NonAcademic/RequestLeavingCertificatesView"><i class="fa-solid fa-file icon"></i><span class="text nav-text">Character Certificates</span></a></li>
