...
<body>
    <div class="layout">
        ...
        <div class="attendance-container">
            ...
            <form action="<?= URLROOT; ?>/teacher/viewAttendance" method="GET" novalidate>
            ...
            <form action="<?= URLROOT; ?>/teacher/viewAbsences" method="GET" novalidate>
                <label for="absence_date">Select Date:</label>
                <input type="date" id="absence_date" name="attendance_date" required>
                <input type="hidden" name="class" value="<?= $data['class'] ?? '' ?>">
