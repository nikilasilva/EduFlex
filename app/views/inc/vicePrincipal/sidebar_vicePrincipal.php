<div class="menu-bar">
    <div class="menu">
        <ul class="menu-links">
            ...
            <li class="nav-links"><a href="<?php echo URLROOT ?>/ExtraEvent/CreateEvent"><i class="fa-solid fa-calendar-plus icon"></i><span class="text nav-text">Create Event</span></a></li>
